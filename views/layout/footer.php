<footer class="bg-white dark:bg-gray-900">
    <div class="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
            ...
            <div class="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
                <div>
                    ...
                    <ul class="text-gray-500 dark:text-gray-400 font-medium">
                        <li class="mb-4">
                            <a href="#" target="_blank" class="hover:underline ">Email</a>
                        </li>
                        <li class="mb-4">
                            <a href="#" target="_blank" class="hover:underline">Teléfonos</a>
                        </li>
                        <li>
                            <a href="#" target="_blank" class="hover:underline">WhatsApp</a>
                        </li>
                    </ul>
                </div>
            </div>
        ...
        <span class="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2024 <a href="https://flowbite.com/"
            class="hover:underline">Jesus</a>. All Rights Reserved.
        </span>
